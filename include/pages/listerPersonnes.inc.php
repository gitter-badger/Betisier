    ...
    <form>
        <table class="remonter">
            ...
            <?php foreach ($listePersonnes as $personne) { ?>
                <tr>
                    <td>
                        <b><a href='index.php?page=2&amp;pernum=<?php echo $personne->getNumPersonne(); ?>'><?php echo $personne->getNumPersonne() ?></a></b>
                    </td>
    ...
    if ($managerPersonne->estEtudiant($_GET['pernum'])) {
        ...
        <table>
            ...
            <?php foreach ($etud as $personne) { ?>
				<tr><td><?php echo $personne[0]?></td><td><?php echo $personne[1]?></td>
					<td><?php echo $personne[2]?></td>
					<td><?php echo $personne[3]?></td>
					<td><?php echo $personne[4]?></td></tr>
				</br>
			<?php } ?>
        </table>
